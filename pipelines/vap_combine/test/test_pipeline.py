...
def test_vap_combine_pipeline():
    ...
    from pipelines.vap_waves.test.test_pipeline import test_vap_waves_pipeline
    from pipelines.vap_gps.test.test_pipeline import test_vap_gps_pipeline
    ...
    run_dates = ["20210819.000000", "20210820.000000"]
